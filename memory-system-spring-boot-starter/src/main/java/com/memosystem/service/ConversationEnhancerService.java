...
public interface ConversationEnhancerService {
     ...
     * @return 增强后的提示词
     */
    String buildEnhancedPrompt(String userMessage, String memoryContext, String globalContext, String shortMemoryContext);
     ...
     * @return
     */
    String buildSystemInstruction(ParsedMessage parsedMessage, String memoryContext, String globalContext, String shortMemoryContext);
